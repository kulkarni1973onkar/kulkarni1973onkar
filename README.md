...
> Backend & infrastructure engineer working at the intersection of **distributed systems and AI**. I build the data plumbing, APIs, and cloud infrastructure that production AI features depend on.

**2+ years** of full-stack experience with a focus on Java/Spring Boot, Node.js, Go, AWS/Azure, and the data and inference layers behind modern AI applications.

📍 New York, NY · 🎓 M.S. Computer Science · 💼 Open to backend / platform / AI infrastructure roles
...
| Domain | What I build |
|---|---|
| **Backend Systems** | REST APIs, microservices, JWT/RBAC auth, Spring Boot, Node.js, and Go services that hold up under load |
| **AI & LLM Integration** | RAG pipelines, multi-model LLM orchestration, embeddings-based retrieval, prompt engineering |
| **Data** | SQL schema design, query optimization, vector stores, real-time data pipelines |
| **Cloud** | AWS & Azure deployments, Supabase, serverless functions, multi-environment architecture |
| **Infrastructure & DevOps** | Docker, Kubernetes, Jenkins/GitHub Actions CI/CD, infrastructure as code |
...
- Healthcare platform powered by a **RAG pipeline** combining GPT-4o-mini and Gemini for medical context retrieval and response generation
- Full-stack architecture on **Next.js + Supabase** — auth, Postgres data layer, and storage handled through a single managed backend
...
- High-performance **Go (Fiber)** backend serving a drag-and-drop form builder with real-time response streaming over **WebSockets**
- **Redis** pub/sub for live analytics — submissions propagate to dashboards in milliseconds
- **MongoDB** for flexible form schema storage; fully containerized with **Docker** for portable deployment
...
![Embeddings](https://img.shields.io/badge/Embeddings-FF4081?style=for-the-badge&logoColor=white)
...
![OAuth 2.0](https://img.shields.io/badge/OAuth_2.0-2C8EBB?style=for-the-badge&logo=auth0&logoColor=white)
![RBAC](https://img.shields.io/badge/RBAC-D32F2F?style=for-the-badge&logoColor=white)
...
<p align="center">
  <img
    src="https://streak-stats.demolab.com/?user=kulkarni1973onkar&theme=tokyonight&hide_border=true"
    alt="GitHub Streak"
  />
</p>
...
<p align="center">
  <img
    src="https://github-profile-trophy.vercel.app/?username=kulkarni1973onkar&theme=tokyonight&no-frame=true&no-bg=true&margin-w=10&column=7"
    alt="GitHub Trophies"
  />
</p>
...
<p align="center">
  <i>Always shipping. Always learning. Open to interesting backend, AI infrastructure, and platform problems.</i>
</p>
